 ...
 */
final class Version20190701083222 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE attribut_moyen_paiements_utilisateur (attribut_moyen_paiements_id INT NOT NULL, utilisateur_id INT NOT NULL, INDEX IDX_3302E3F5C7B9BAA5 (attribut_moyen_paiements_id), INDEX IDX_3302E3F5FB88E14F (utilisateur_id), PRIMARY KEY(attribut_moyen_paiements_id, utilisateur_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE attribut_moyen_paiements_event (attribut_moyen_paiements_id INT NOT NULL, event_id INT NOT NULL, INDEX IDX_518F8396C7B9BAA5 (attribut_moyen_paiements_id), INDEX IDX_518F839671F7E88B (event_id), PRIMARY KEY(attribut_moyen_paiements_id, event_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE attribut_moyen_paiements_utilisateur ADD CONSTRAINT FK_3302E3F5C7B9BAA5 FOREIGN KEY (attribut_moyen_paiements_id) REFERENCES attribut_moyen_paiements (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE attribut_moyen_paiements_utilisateur ADD CONSTRAINT FK_3302E3F5FB88E14F FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE attribut_moyen_paiements_event ADD CONSTRAINT FK_518F8396C7B9BAA5 FOREIGN KEY (attribut_moyen_paiements_id) REFERENCES attribut_moyen_paiements (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE attribut_moyen_paiements_event ADD CONSTRAINT FK_518F839671F7E88B FOREIGN KEY (event_id) REFERENCES event (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE attribut_moyen_paiements_utilisateur DROP FOREIGN KEY FK_3302E3F5C7B9BAA5');
        $this->addSql('ALTER TABLE attribut_moyen_paiements_event DROP FOREIGN KEY FK_518F8396C7B9BAA5');
        $this->addSql('ALTER TABLE attribut_moyen_paiements_event DROP FOREIGN KEY FK_518F839671F7E88B');
        ...
        $this->addSql('ALTER TABLE attribut_moyen_paiements_utilisateur DROP FOREIGN KEY FK_3302E3F5FB88E14F');
        ...
        $this->addSql('DROP TABLE attribut_moyen_paiements_utilisateur');
        $this->addSql('DROP TABLE attribut_moyen_paiements_event');
